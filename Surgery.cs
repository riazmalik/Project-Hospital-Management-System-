    ...
    public partial class Surgery : Form
    {
      ...
      //  int indexROw;
        ...
        private void Surgery_Load(object sender, EventArgs e)
        {
            ...
            cmd = new SqlCommand("select Name from InPatient where Prefered='Surgery'", conn);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            cmd = new SqlCommand("Insert into Surgery(Name,P_ID,Gender,Age,PType,Departement,Doctor,SurgeryDate,SurgeryType)values(@Name,@P_ID,@Gender,@Age,@PType,@Departement,@Doctor,@SurgeryDate,@SurgeryType);", conn);
            ...
            cmd.Parameters.AddWithValue("@SurgeryDate", dateTimePicker1.Value);
            cmd.Parameters.AddWithValue("@SurgeryType", textBox6.Text);
